 ...
 * @link       https://github.com/dieze/DzProject/blob/master/tests/acceptance/AddProjectCept.php
 */
...
$I->fillField("input[name='beginDate']", "0");
$I->fillField("input[name='endDate']", "946684800");
