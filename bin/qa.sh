...
setdevelopment () {
    ...
    cp -vf public/dzproject.php ../../public
    cp -vf public/dzproject.test.php ../../public

    chmod -v 644 ../../public/dzproject.php
    chmod -v 644 ../../public/dzproject.test.php
}
...
setproduction () {
    ...
    rm -vf ../../public/dzproject.php
    rm -vf ../../public/dzproject.test.php
}
...
genclassmap () {
    ...
    ../../vendor/bin/classmap_generator.php --library src/DzProjectModule --output ./autoload_classmap.php --overwrite --sort .
}
